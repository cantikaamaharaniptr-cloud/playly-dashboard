# docs/glossary.md - Kamus Istilah PLAYLY DASHBOARD
...
- **Apa ini?** Kamus istilah domain proyek PLAYLY DASHBOARD. Tempat rujukan tunggal
...
|-------|---------|--------|-----------|
| 1 | 2026-06-29 | [TBD: <nama>] | Inisialisasi template glossary. |
